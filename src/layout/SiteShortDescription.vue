<template>
  <div class="text-base 2xl:text-2xl text-gray-600">
    <h1>Peer-to-Peer Cryptocurrency Exchanges Aggregator</h1>
...
export default {
  ...
  methods: {
    getCryptocurrencyName(code) {
      return CryptocurrencyService.getCryptocurrencyNameBy(code)
    }
  }
}
</script>
